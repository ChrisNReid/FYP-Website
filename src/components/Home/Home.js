...
import { Container, Row, Col, Carousel } from "react-bootstrap"; // Importing Carousel along with Container, Row, and Col
import uosCrest from "../../Assets/uosCrest.png";
...
function Home() {
  return (
    <section>
      ...
      <Container fluid className="home-section" id="analysis">
      <Container>
        <Row className="justify-content-center">
          ...
          <h2 style={{ fontSize: "2.6em", marginBottom: "10px" }}>
            ...
            <br /><br />
            <h4 style={{ fontSize: "2.0em", marginBottom: "10px", textAlign: "left"}}>
                ...
                <Carousel style={{ maxWidth: '50%', margin: 'auto' }}>
                  ...
                  <Carousel.Item>
                    ...
                    <Carousel.Caption>
                      ...
                      <p>Vision to target object is obscured/blocked.</p>
                    </Carousel.Caption>
                  </Carousel.Item>
                </Carousel>
              </Col>
